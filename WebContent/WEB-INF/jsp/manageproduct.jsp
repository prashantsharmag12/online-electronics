				...
				<div class="panel-body">
					...
					<sf:form class="form-horizontal" modelAttribute="product"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="text" path="quantity"
									placeholder="Enter quantity of product!" class="form-control" />
								...
								<c:if test="${product.id == 0}">
									...
									<div class="text-right">
										<button type="button" data-toggle="modal"
											data-target="#myCategoryModal" class="btn btn-warning btn-xs">New
											Catgeory</button>
									</div>
								</c:if>
							</div>
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="discount">Enter
								Available Discount:</label>
							<div class="col-md-8">
								<sf:input type="number" path="discount"
									placeholder="Enter available discount!" class="form-control" />
								<em class="help-block">Please enter Available Discount!</em>
							</div>
						</div>
						<div class="form-group">
					...
					<sf:form modelAttribute="category"
						...
						<div class="form-group">
							<label for="category_description" class="control-label col-md-4">Category
								Description</label>
							<div class="col-md-8">
								<sf:textarea type="text" rows="4" path="description"
